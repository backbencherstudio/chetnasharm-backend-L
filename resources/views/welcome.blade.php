...
<body class="bg-brand-soft min-h-screen font-sans text-slate-900 antialiased">
    <div class="relative flex min-h-screen items-center justify-center overflow-hidden px-6 py-16">
        <div class="pointer-events-none absolute top-16 -left-24 size-72 rounded-full bg-violet-200/50 blur-3xl"></div>
        ...
        <main class="relative z-10 mx-auto w-full max-w-3xl text-center">
            ...
            <div class="text-brand-muted mt-8 inline-flex items-center gap-2 rounded-full border border-violet-200 bg-white px-4 py-2 text-sm font-medium shadow-sm">
                <span class="bg-brand size-2 animate-pulse rounded-full"></span>
                Under construction
            </div>
            ...
            <p class="mx-auto mt-5 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
                We’re polishing a fresh design and improved features. Thanks for your patience while we get ready to
                launch.
            </p>
